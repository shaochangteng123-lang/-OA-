<template>
  <div class="business-reimbursement-container">
    <el-card class="page-card">
      ...
      <template #header>
        <div class="card-header">
          <div class="page-title-area">
            ...
            <span class="page-title-text">商务报销</span>
          </div>
          <el-button
            :icon="Plus"
            class="action-btn action-btn--business"
            @click="handleCreate"
          >
            新建商务报销单
          </el-button>
      ...
      <div class="content-wrapper">
        ...
        >
          <template #default>
            <p>商务报销适用于商务接待、客户拜访、商务差旅等业务活动产生的费用。</p>
        ...
        >
          ...
          <el-table-column prop="title" label="商务活动" min-width="150" align="center">
          ...
          <el-table-column prop="client" label="客户/对象" min-width="120" align="center" />
          ...
          <div v-if="currentApprovalRecord" class="approval-detail">
            ...
            <div class="info-section">
              ...
              <el-descriptions :column="2" border>
                ...
                <el-descriptions-item label="报销类型">{{ currentApprovalRecord.category || '商务报销' }}</el-descriptions-item>
              ...
              <el-timeline>
                ...
                >
                  <div class="timeline-content">
                    ...
                    <div class="timeline-desc">{{ currentApprovalRecord.status === 'approved' ? '等待财务确认付款...' : '财务已确认付款' }}</div>
                  </div>
                </el-timeline-item>
...
const handleDelete = (row: any) => {
  ElMessageBox.confirm('确定要删除这条商务报销单吗？', '提示', {
    confirmButtonText: '确定',
    cancelButtonText: '取消',
    type: 'warning',
  })
