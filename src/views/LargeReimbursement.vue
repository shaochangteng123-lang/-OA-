    ...
    <el-card class="page-card">
      ...
      <div class="content-wrapper">
        ...
        >
          ...
          <el-table-column prop="category" label="报销类型" min-width="120" align="center">
            <template #default="{ row }">
              {{ row.invoiceCategory || '-' }}
            </template>
          </el-table-column>
              ...
              <el-timeline>
                ...
                >
                  <div class="timeline-content">
                    ...
                    <div class="timeline-desc">{{ currentApprovalRecord.status === 'approved' ? '等待管理员确认付款...' : '管理员已确认付款' }}</div>
                  </div>
                </el-timeline-item>
                ...
                >
                  <div class="timeline-content">
                    ...
                    <div class="timeline-desc">等待管理员上传付款回单...</div>
                  </div>
                </el-timeline-item>
